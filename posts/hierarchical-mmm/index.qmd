...
idata_unpooled = az.InferenceData.from_netcdf(ASSETS / "idata_unpooled.nc")
prior_unpooled = az.InferenceData.from_netcdf(ASSETS / "prior_unpooled.nc")
idata_centered_pp = az.InferenceData.from_netcdf(ASSETS / "idata_centered.nc")
prior_centered_pp = az.InferenceData.from_netcdf(ASSETS / "prior_centered.nc")
idata_non_centered_pp = az.InferenceData.from_netcdf(ASSETS / "idata_noncentered.nc")
prior_non_centered_pp = az.InferenceData.from_netcdf(ASSETS / "prior_noncentered.nc")
idata_tuned_non_centered_pp = az.InferenceData.from_netcdf(ASSETS / "idata_tuned.nc")
prior_tuned_non_centered_pp = az.InferenceData.from_netcdf(ASSETS / "prior_tuned.nc")
```
...
![Unpooled model graph](assets/model_unpooled.png){width=100%}
...
![Centred hierarchical model graph](assets/model_centered.png){width=100%}
...
![Non-centred hierarchical model graph](assets/model_noncentered.png){width=100%}
...
![Tuned non-centred hierarchical model graph](assets/model_tuned.png){width=100%}
